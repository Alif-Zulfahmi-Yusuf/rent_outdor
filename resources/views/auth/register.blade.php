                        ...
                        <div class="row align-items-center gx-0 gy-7">
                            <div
                                ...
                                <div
                                    ...
                                    <h3 class="mb-3 text-body-emphasis fs-7">Welcome to
                                ...
                                <div class="auth-form-box">
                                    <div class="text-center mb-7"><a
                                            ...
                                            <div class="d-flex align-items-center fw-bolder fs-3 d-inline-block">
                                                <img src="assets/img/icons/logo.png" alt="" width="50" />
                                            </div>
                                        </a>
                                        <h3 class="text-body-highlight">Selamat Datang</h3>
                                        <p class="text-body-tertiary">Silakan daftarkan akun Anda untuk melanjutkan.
                                        </p>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('register') }}"
                                        ...
                                        <div class="mb-3 text-start">
                                            ...
                                            <input id="name" type="text"
                                                ...
                                                autocomplete="name" autofocus placeholder="Masukan Name" />
                                            @error('name')
                                        ...
                                        <div class="text-center"><a class="fs-9 fw-bold"
                                                href="{{ route('login') }}">Sign in to an
