...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/img/favicons/favicon-32x32.png') }}">
                ...
                <div class="col-12 col-xl-10 col-xxl-8">
                    <div class="row justify-content-center align-items-center g-5">
                        <div class="col-12 col-lg-6 text-center order-lg-1"><img class="img-fluid w-lg-100 d-dark-none"
                                src="{{ asset('assets/img/spot-illustrations/403-illustration.png') }}" alt=""
                        ...
                        <div class="col-12 col-lg-6 text-center text-lg-start"><img
                            ...
                            <p class="text-body mb-5">Halt! Thou art endeavouring to trespass upon a realm not granted
                                ...
                                class="btn btn-lg btn-outline-primary" href="{{ route('dashboard.index') }}">Go
                                Home</a>
                        </div>
                    </div>
                </div>
